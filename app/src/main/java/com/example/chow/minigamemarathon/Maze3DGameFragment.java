...
public class Maze3DGameFragment extends GameFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rootView = (ViewGroup) inflater.inflate(R.layout.maze_3d_layout, container, false);
        return rootView;
    }
    ...
    public void assignWidgetFunctions() {
        ...
        MazeView mazeView = new MazeView(getActivity(), maze3D, Color.WHITE, 0);
        rootView.addView(mazeView);
    }
